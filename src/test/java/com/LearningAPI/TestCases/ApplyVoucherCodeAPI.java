...
public class ApplyVoucherCodeAPI extends BaseTest {
	...
	public void init() {
		...
		test = rep.startTest("ApplyVoucherCodeAPI");
	...
	@Test(dataProvider = "getData", priority = 0, testName = "Verify Voucher Code API")

	public void ApplyVoucherCodeAPI_Test(Hashtable<String, String> data) throws Exception {

		String Checksum_Data = Constants.APIKey + ":" + data.get("voucher_code") + ":" + data.get("user_id") + ":"
				+ data.get("flag") + ":" + data.get("board_id") + ":" + data.get("class_id") + ":"
				+ data.get("offer_for") + ":" + Constants.Salt;

		test.log(LogStatus.INFO, "ApplyVoucherCodeAPI Test started");
		if (!DataUtil.isTestRunnable(xls, "ApplyVoucherCodeAPI") || data.get("Runmode").equals("N")) {
		...
		String Resource = "api/v1.0/applyvouchercode";

		String Querystring = "?" + "apikey=" + Constants.APIKey + "&checksum=" + checksum + "&voucher_code="
				+ data.get("voucher_code") + "&user_id=" + data.get("user_id") + "&flag=" + data.get("flag")
				+ "&board_id=" + data.get("board_id") + "&class_id=" + data.get("class_id") + "&offer_for="
				+ data.get("offer_for");
	...
	public Object[][] getData() {
		...
		Object[][] data = DataUtil.getData(xls, "ApplyVoucherCodeAPI");
		return data;
	}
