...
public class CheckDeviceAPI extends BaseTest {
	...
	public void init() {
		...
		test = rep.startTest("CheckDeviceAPI");
	...
	@Test(dataProvider = "getData", priority = 0, testName = "VerifyCheckDevice")

	public void CheckDeviceAPI_Test(Hashtable<String, String> data) throws Exception {

		String Checksum_Data = data.get("device_id") + ":" + Constants.APIKey + ":" + Constants.Salt;

		test.log(LogStatus.INFO, "CheckDeviceAPI Test started");
		if (!DataUtil.isTestRunnable(xls, "CheckDeviceAPI") || data.get("Runmode").equals("N")) {
		...
		String Resource = "api/v1.0/checkdevice";

		String Querystring = "?" + "device_id=" + data.get("device_id") + "&apikey=" + Constants.APIKey + "&checksum="
				+ checksum;
	...
	public Object[][] getData() {
		...
		Object[][] data = DataUtil.getData(xls, "CheckDeviceAPI");
		return data;
	}
