...
public class UserSubscriptionList extends BaseTest {
	...
	public void init() {
		...
		test = rep.startTest("UserSubscriptionList");
	...
	@Test(dataProvider = "getData", priority = 0, testName = "Verify User-SubscriptionList")

	public void UserSubscriptionList_Test(Hashtable<String, String> data) throws Exception {

		String Checksum_Data = data.get("user_id") + ":" + Constants.APIKey + ":" + Constants.Salt;

		test.log(LogStatus.INFO, "UserSubscriptionList Test started");
		if (!DataUtil.isTestRunnable(xls, "UserSubscriptionList") || data.get("Runmode").equals("N")) {
		...
		String Resource = "api/v1.0/usersubscriptionlist";
	...
	public Object[][] getData() {
		...
		Object[][] data = DataUtil.getData(xls, "UserSubscriptionList");
		return data;
	}
