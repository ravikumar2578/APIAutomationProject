...
public class GetSubjectByPackageId_API extends BaseTest {
	...
	public void init() {
		...
		test = rep.startTest("GetSubjectByPackageId_API");
	...
	@Test(dataProvider = "getData", priority = 0, testName = "Verify Subject by Package Id")

	public void GetSubjectByPackageId_API_Test(Hashtable<String, String> data) throws Exception {

		String Checksum_Data = Constants.APIKey + ":" + data.get("package_id") + ":" + Constants.Salt;

		test.log(LogStatus.INFO, "GetSubjectByPackageId_API Test started");
		if (!DataUtil.isTestRunnable(xls, "GetSubjectByPackageId_API") || data.get("Runmode").equals("N")) {
		...
		String Resource = "api/v1.0/getsubjectsbypackage";

		String Querystring = "?" + "apikey=" + Constants.APIKey + "&checksum=" + checksum + "&package_id="
				+ data.get("package_id");
	...
	public Object[][] getData() {
		...
		Object[][] data = DataUtil.getData(xls, "GetSubjectByPackageId_API");
		return data;
	}
