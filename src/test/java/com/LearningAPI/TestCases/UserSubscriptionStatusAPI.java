...
public class UserSubscriptionStatusAPI extends BaseTest {
	...
	public void init() {
		...
		test = rep.startTest("UserSubscriptionStatusAPI");
	...
	@Test(dataProvider = "getData", priority = 0, testName = "Verify User-SubscriptionStatus")

	public void UserSubscriptionStatusAPI_Test(Hashtable<String, String> data) throws Exception {

		String Checksum_Data = data.get("user_id") + ":" + Constants.APIKey + ":" + Constants.Salt;

		test.log(LogStatus.INFO, "UserSubscriptionStatusAPI Test started");
		if (!DataUtil.isTestRunnable(xls, "UserSubscriptionStatusAPI") || data.get("Runmode").equals("N")) {
		...
		String Resource = "api/v1.0/usersubscriptionstatus";
	...
	public Object[][] getData() {
		...
		Object[][] data = DataUtil.getData(xls, "UserSubscriptionStatusAPI");
		return data;
	}
